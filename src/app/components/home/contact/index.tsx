...
const Contact = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch("https://formsubmit.co/ajax/shitendra777@gmail.com", {
      method: "POST",
  ...
  return (
    <section className="no-print" id="contact-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-7 sm:gap-12">
                ...
                <button
                  type="submit"
                  className="relative overflow-hidden cursor-pointer w-fit py-2 sm:py-3 md:py-5 px-4 sm:px-5 md:px-7 border border-primary rounded-full group hover-fill"
                >
            ...
            <div className="flex flex-col sm:flex-row md:flex-col justify-between gap-5 md:gap-20 items-center md:items-end">
              ...
              <div className="flex flex-wrap justify-center gap-5 lg:gap-11 items-end"></div>
            </div>
          </div>
        </div>
      </div>
